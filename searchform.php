...
<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <div class="relative flex items-center">
        ...
        <button
            type="submit"
            class="absolute right-2 rounded-full bg-red-600 px-6 py-3 text-sm font-semibold uppercase tracking-wide text-white transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 md:px-8 md:py-4"
        >
            <?php esc_html_e('Search', 'beit'); ?>
        </button>
    </div>
