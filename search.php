                        ...
                        <article class="flex h-full flex-col overflow-hidden   transition hover:-translate-y-1"
                            ...
                            <div class="flex flex-1 flex-col gap-3 py-6">
                                ...
                                <h2 class="text-lg font-bold text-slate-900">
                                    <a class="transition hover:text-[var(--main-color)]"
                        ...
                        <article class="flex h-full flex-col overflow-hidden transition hover:-translate-y-1"
                            ...
                            <div class="flex flex-1 flex-col gap-3 py-6">
                                <?php if ($post_type !== 'post' && $post_type !== 'page'): ?>
                                    <span class="inline-flex items-center gap-2 text-xs font-bold text-[var(--main-color)]">
                                        <i class="fa fa-tag"></i>
        ...
        <?php else: ?>
            <div class="mx-auto max-w-2xl text-center">
                ...
                <div class=" bg-slate-50 p-12 shadow-inner">
                    <div
                        class="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-red-100 text-[var(--main-color)]">
                    ...
                    <div class="space-y-4">
                        ...
                        <ul class="mx-auto max-w-md space-y-2 text-left text-sm text-slate-600">
                            <li class="flex items-start gap-2">
                                <i class="fa fa-check text-[var(--main-color)] mt-1"></i>
