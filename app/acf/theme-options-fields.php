        ...
        'fields' => [
            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        'key' => 'field_theme_contact_address_ar',
                        'label' => 'العنوان (عربي)',
                        'name' => 'address_ar',
                        'type' => 'textarea',
                        'rows' => 3,
                        'instructions' => 'العنوان باللغة العربية',
                        'wrapper' => ['width' => '50'],
                    ],
                    [
                        'key' => 'field_theme_contact_address_en',
                        'label' => 'العنوان (English)',
                        'name' => 'address_en',
                        'type' => 'textarea',
                        'rows' => 3,
                        'instructions' => 'Address in English',
                        'wrapper' => ['width' => '50'],
                    ],
                    ...
                    [
                        ...
                        'type' => 'textarea',
                        'rows' => 3,
                        'instructions' => 'هذا الحقل قديم - استخدم الحقول الجديدة أعلاه',
