...
while (have_posts()) {
    ...
    ?>
                            ...
                            ?>
                                <form class="space-y-4">
                                    ...
                                    <div class="flex flex-wrap items-center gap-4">
                                        ...
                                        <button type="reset" class="font-bold text-red-600 underline hover:text-red-700">
                            ...
                            <div class=" bg-white shadow-sm" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="flex border-b border-gray-200 relative z-10">
                                    <div class="map-tab-wrapper flex-1 relative">
                                        <button
                                            class="map-tab-button w-full px-6 py-4 text-sm font-bold text-gray-700 transition hover:bg-gray-50 border-b-2 border-transparent"
                                            data-tab="offices" data-active="false">
                                            <i class="fa fa-map-marker ltr:mr-2 rtl:ml-2"></i>
                                            <?php echo esc_html(beit_translate('Our Offices', 'our_offices')); ?>
                                        </button>
                                        <!-- Dropdown for Offices -->
                                        <div
                                            class="map-tab-dropdown hidden absolute top-full ltr:left-0 rtl:right-0 w-full bg-white shadow-lg border border-gray-200 z-50 max-h-64">
                                            <?php if (!empty($map_offices)): ?>
                                                    <?php foreach ($map_offices as $index => $office): ?>
                                                            <button
                                                                ...
                                                                data-tab="offices" data-location-index="<?php echo esc_attr($index); ?>">
                                                                ...
                                                                <?php if (!empty($office['address'])): ?>
                                                                        <br><span
                                                                            class="text-xs text-gray-500 ltr:ml-5 rtl:mr-5"><?php echo esc_html($office['address']); ?></span>
                                                                <?php endif; ?>
                                                            </button>
                                                    <?php endforeach; ?>
                                            <?php endif; ?>
                                    ...
                                    <div class="map-tab-wrapper flex-1 relative">
                                        <button
                                            ...
                                            <?php echo esc_html(beit_translate('Warehouses', 'warehouses')); ?>
                                        </button>
                                            ...
                                            <?php if (!empty($map_warehouses)): ?>
                                                    <?php foreach ($map_warehouses as $index => $warehouse): ?>
                                                            <button
                                                                ...
                                                                data-tab="warehouses" data-location-index="<?php echo esc_attr($index); ?>">
                                                                ...
                                                                <?php if (!empty($warehouse['address'])): ?>
                                                                        <br><span
                                                                            class="text-xs text-gray-500 ltr:ml-5 rtl:mr-5"><?php echo esc_html($warehouse['address']); ?></span>
                                                                <?php endif; ?>
                                                            </button>
                                                    <?php endforeach; ?>
                                            <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex items-start gap-3 border border-black/20 bg-white p-6 ltr:text-left rtl:text-right">
                            <span class="w-12 h-12 flex justify-center items-center text-white bg-primary"><i
                                    class="fa fa-globe text-xl"></i></span>
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3 text-gray-700">
                                    ...
                                    if (!empty($social_links)) {
                                        foreach ($social_links as $social) {
                                            ...
                                            ?>
                                                    <a class="transition hover:text-red-600 flex justify-center items-center    "
        ...
        <?php if ($google_maps_api_key): ?>
                ...
                <script
                    src="https://maps.googleapis.com/maps/api/js?key=<?php echo esc_attr($google_maps_api_key); ?>&callback=initContactMap"
                    async defer></script>
        <?php endif; ?>
<?php
}
