                            ...
                            <form class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <select class="form-field text-gray-500">
                                        <option value=""><?php esc_html_e('Reason', 'beit'); ?></option>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm space-y-4">
                        ...
                        <?php if ($address): ?>
                            <div class="flex items-center gap-4">
                                ...
                                <div class="ltr:text-left rtl:text-right">
                                    <span class="text-sm text-gray-500"><?php esc_html_e('Address', 'beit'); ?></span>
                                    <p class="text-gray-800 font-medium"><?php echo esc_html($address); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                                ...
                                <?php foreach ($offices as $office):
                                    ...
                                    <div class="border-b border-gray-100 pb-4 last:border-0 last:pb-0 ltr:text-left rtl:text-right">
                                        ...
                                        <?php if ($office_address): ?>
                                            <p class="mt-1 text-sm text-gray-600"><?php echo esc_html($office_address); ?></p>
                                        <?php endif; ?>
                                        <?php if ($map_link): ?>
