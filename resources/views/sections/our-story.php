...
<section class="bg-[#282828] text-white overflow-hidden">
    <div class=" mx-auto ">
        <div class="grid gap-8 md:gap-12 md:grid-cols-2 md:items-center">
            ...
            <div class="space-y-4 md:space-y-6 <?php echo esc_attr($content_alignment); ?> max-w-lg mx-auto ltr:text-left rtl:text-right" data-aos="<?php echo is_rtl() ? 'fade-right' : 'fade-left'; ?>" data-aos-delay="200">
