...
if (function_exists('get_field')) {
    ...
    $topbar_search_label = get_field('topbar_search_label' . $lang_suffix, 'option') ?: get_field('topbar_search_label', 'option') ?: beit_translate('Search');
            ...
            <div class="container mx-auto px-3 sm:px-4 md:px-5 lg:px-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 sm:gap-2.5 md:gap-3 w-full">
                            ...
                            <a href="<?php echo esc_url(home_url('/')); ?>"
                                ...
                                <?php if ($site_logo): ?>
                                    <?php echo wp_get_attachment_image($site_logo, 'medium', false, [
                                        'class' => 'logo-default transition-opacity duration-300 h-20',
                        ...
                        <button
                            class="mr-auto inline-flex items-center justify-center border border-white/40 p-2 sm:p-2.5 text-white transition hover:border-white hover:bg-white/10 lg:hidden rounded-full"
