        ...
        <div class="flex flex-col items-center gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div class="text-center text-white text-base font-medium">
                ...
                printf(
                    ...
                    esc_html(beit_translate('© %1$s %2$s. All rights reserved.', 'copyright_text')),
                    esc_html(gmdate('Y')),
            ...
            <div class="flex items-center justify-center md:justify-end">
                <button id="back-to-top" type="button"
                    class="w-12 h-12 inline-flex items-center justify-center bg-primary ext-white hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500">
