...
/**
 * Archive template for Annual Reports.
 *
 * @package beit
 */
...
$archive_title = post_type_archive_title('', false) ?: __('Annual Reports', 'beit');
            ...
            <?php else: ?>
                <div class=" border border-slate-200 bg-white p-12 text-center shadow-sm">
                    ...
                    <h2 class="text-2xl font-semibold text-slate-900">
                        <?php echo esc_html__('No Annual Reports Found', 'beit'); ?>
                    </h2>
                    <p class="mt-2 text-sm text-slate-600">
                        <?php echo esc_html__('Check back soon for the latest reports.', 'beit'); ?>
                    </p>
                </div>
            <?php endif; ?>
        </div>
