    ...
    <main class="bg-white text-slate-900">
        <article class="container mx-auto grid gap-12 px-4 py-16 md:grid-cols-[minmax(0,3fr)_minmax(0,1fr)] md:px-6">
            <div class="space-y-10">
                <?php if ($thumbnail): ?>
                    <figure class="overflow-hidden  shadow-lg">
                        <?php echo wp_get_attachment_image($thumbnail, 'full', false, ['class' => 'w-full object-cover']); ?>
                    </figure>
                <?php endif; ?>

                <div
                    class="wp-content prose max-w-none prose-slate prose-headings:font-bold prose-a:text-[var(--main-color)] hover:prose-a:text-red-700">
                    <?php the_content(); ?>
                </div>
                                ...
                                <li>
                                    <a class="flex gap-3 transition hover:text-[var(--main-color)]" href="<?php the_permalink(); ?>">
                                        ...
                                        <span class="flex-1">
                                            ...
                                            <span class="block font-bold"><?php echo esc_html($related_title); ?></span>
                                        </span>
                                    </a>
                                </li>
                            <?php
