    ...
    <main class="bg-white text-slate-900">
        <article class="container mx-auto grid gap-12 px-4 py-16 md:grid-cols-[minmax(0,3fr)_minmax(0,1fr)] md:px-6">
            <div class="space-y-10">
                ...
                <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-50 p-8 shadow-lg" data-aos="fade-up" data-aos-delay="250">
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-3">
                            ...
                            ?>
                                <a href="<?php echo $link['url']; ?>"
                                   ...
                                   <?php endif; ?>
                                   class="group relative inline-flex h-14 w-14 transform items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br <?php echo $link['bg']; ?>  shadow-lg <?php echo $link['shadow']; ?> transition-all duration-300 <?php echo $link['hover']; ?> hover:scale-110 hover:shadow-xl"
                            ...
                            <button onclick="copyToClipboard()"
                                    id="copyLinkBtn"
                                    class="group relative inline-flex h-14 w-14 transform items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-slate-700 to-slate-800 shadow-lg shadow-slate-700/50 transition-all duration-300 hover:from-slate-800 hover:to-slate-900 hover:scale-110 hover:shadow-xl"
                    ...
                    <section class="mt-16 border-t border-slate-200 pt-12" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            while ($latest_articles->have_posts()) :
                                ...
                                ?>
                                <article class="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-md transition-all duration-300 hover:shadow-xl" data-aos="fade-up" data-aos-delay="<?php echo 100 + ($latest_articles->current_post * 50); ?>">
                                    <?php if ($article_thumb) : ?>
                                        <a href="<?php the_permalink(); ?>" class="block relative overflow-hidden aspect-[16/10]">
                                            ...
                                            <?php if ($article_cat) : ?>
                                                <span class="absolute top-3 <?php echo $is_rtl ? 'right-3' : 'left-3'; ?> inline-block rounded-full bg-red-600 px-3 py-1 text-xs font-semibold text-white shadow-lg">
                                    ...
                                    <div class="flex flex-1 flex-col p-5">
                                        ...
                                        <h3 class="mb-3 line-clamp-2 h-14 text-lg font-bold text-slate-900 transition group-hover:text-red-600">
